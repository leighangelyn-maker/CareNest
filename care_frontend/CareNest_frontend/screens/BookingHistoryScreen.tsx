...
import { getMyAddresses, addAddress, createBooking, getAgencyById } from '../services/api';
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.centered}>
          ...
          <Text style={styles.successBody}>
            ...
            come back to complete payment from your Booking History.
          </Text>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.noteBox}>
          <Text style={styles.noteText}>
            Price isn't set yet — you'll agree on a rate by phone with the agency
            after booking, then complete payment from Booking History.
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  noteBox:          { backgroundColor: '#F5F5F5', borderWidth: 1, borderColor: '#E0E0E0', borderRadius: 10, padding: 12, marginTop: 24 },
